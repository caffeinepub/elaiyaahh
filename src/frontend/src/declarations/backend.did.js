...
export const JournalPost = IDL.Record({
  'id' : IDL.Text,
  'title' : IDL.Text,
  'imageUrl' : IDL.Text,
  'excerpt' : IDL.Text,
...
export const idlService = IDL.Service({
  ...
  'addJournalPost' : IDL.Func([JournalPost], [JournalPost], []),
  'addProduct' : IDL.Func([Product], [Product], []),
  'assignCallerUserRole' : IDL.Func([IDL.Principal, UserRole], [], []),
  'deleteJournalPost' : IDL.Func([IDL.Text], [IDL.Bool], []),
  ...
  'getJournalPosts' : IDL.Func([], [IDL.Vec(JournalPost)], ['query']),
  ...
  'updateJournalPost' : IDL.Func([IDL.Text, JournalPost], [IDL.Bool], []),
  'updateProduct' : IDL.Func([IDL.Text, Product], [IDL.Bool], []),
});
